...
public class NiftyDialogBuilder extends Dialog implements DialogInterface {
    ...
    private final float DIALOG_WIDTH_LANDSCAPE = 0.5f;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int screenWidth = getScreenPx(getContext())[0];
        WindowManager.LayoutParams params = getWindow().getAttributes();
        params.height = ViewGroup.LayoutParams.MATCH_PARENT;
        params.width = landScape ?(int) (screenWidth*DIALOG_WIDTH_LANDSCAPE) : (int) (screenWidth*DIALOG_WIDTH);
    ...
    protected void statusBarTranslucent(){
    ...
    public static NiftyDialogBuilder getInstance(Context context) {
        ...
        if (instance == null || !context.equals(tmpContext)) {
            synchronized (NiftyDialogBuilder.class) {
                if (instance == null || !context.equals(tmpContext)) {
                    landScape = ((Activity)context).getRequestedOrientation() == ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE;
    ...
    private void init(Context context) {
        ...
        mCutOff = mDialogView.findViewById(R.id.button_cut_off);
    ...
    public NiftyDialogBuilder withSingleButtonText(CharSequence text) {
        mButton1.setVisibility(View.VISIBLE);
        mButton1.setBackgroundDrawable(getContext().getResources().getDrawable(R.drawable.selector_dialog_single_button));
        mButton1.setText(text);
    ...
    public NiftyDialogBuilder withButton2Text(CharSequence text) {
        mCutOff.setVisibility(View.VISIBLE);
        mButton1.setBackgroundResource(R.drawable.selector_dialog_cancel);
    ...
    public void dismiss() {
        ...
        // Taurus modify 2015-12-21 add handle solute memory leak
        tmpContext = null;
        instance = null;
    }
